 ...
 * All rights reserved.
 *
 * This source code is licensed under the license found @ https://github.com/facebook/nuclide
 */
 ...
 */
export function sourceKittenCompletionToAtomSuggestion(completion: SourceKittenCompletion): atom$AutocompleteSuggestion {
  return {
 ...
 */
export function sourceKittenSourcetextToAtomSnippet(sourcetext: string): string {
